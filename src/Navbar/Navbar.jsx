...
return(
  ...
  <div className="flex justify-evenly text-lg py-4">
    <div
    ...
    >
      ...
      {isFeaturedOpen && (
        <div className=" absolute bg-white flex text-left justify-evenly w-full mt-2 py-8 left-0 transition-transform fade">
          <div className="p-3">
          ...
          <div className="p-3 sm:hidden block">
            <h1 className="my-2 font-semibold text-base cursor-pointer">New for Men and Women</h1>
            <p className=" text-gray-500 text-base cursor-pointer hover:text-black">Shoes</p>
            <p className=" text-gray-500 text-base cursor-pointer hover:text-black">Accessories</p>
            <p className=" text-gray-500 text-base cursor-pointer hover:text-black">Shop All New</p>
          </div>
    ...
    >
      ...
      {isMensOpen && (
        <div className=" absolute bg-white flex text-left justify-evenly w-full mt-2 py-8 left-0 fade">
    ...
    <input type="search" placeholder="Search" className="bg-gray-200 px-5 pt-1 pb-1 rounded-3xl outline-none hover:bg-gray-300 hidden sm:block"/>
