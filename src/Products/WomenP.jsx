    ...
    <div>
      <div className='md:flex justify-evenly w-[95%] py-1 mx-auto shadow-xl rounded-xl'>
        <div className='text-black mx-5 my-auto'>
          <img src={require("../Home/Images/Women.jpg")} alt="Womens" className='w-96 h-72 rounded-lg my-5' />
        </div>
        <div className=' mx-5 md:w-[50%] my-10 text-start'>
          <div className='my-4'>
            <h1 className='text-3xl font-bold'>Casual Wear</h1>
            <p className='text-xl font-semibold'>Women's</p>
          </div>
            <p className='md:pr-20 pr-5 text-gray-600'>
              Elevate your everyday style and step into casual sophistication with our Women's Casual Comfort Shoes. 
              Crafted with meticulous attention to detail, these shoes embody timeless elegance and contemporary comfort, 
              making them the perfect choice for your daily adventures.
            </p>
          <div className='my-4 text-base font-meddium text-gray-600'>
            <p className='text-lg font-semibold text-black'>MRP : ₹6995.00</p>
            <p>incl. of taxes</p>
